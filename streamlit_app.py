...
def vat_cal_sale_shopee(shopee_sale_file, year, store, month):
    df = pd.read_excel(shopee_sale_file, converters={'หมายเลขคำสั่งซื้อ':str}, infer_datetime_format=True, errors='coerce')
    df = df[~df['สถานะการสั่งซื้อ'].isin(['ยกเลิกแล้ว'])].drop_duplicates()
                ...
                if selected_platform != []:
                    ...
                    for j, tab in enumerate(tabs):
                        with tab:
                            ...
                            ################ upload shopee #################
                            if tab_name == 'Shopee': 
                                with st.expander("📥 ดูวิธี Download ไฟล์ยอดขายจาก Shopee"):
                                    st.write('''
                            ...
                            ################# upload lazada #################
                                ...
                                with st.expander("📥 กดดูวิธี Download ไฟล์ยอดขายจาก Lazada"):
                                    st.write('''
                            ...
                            ################# upload TikTok #################
                                ...
                                with st.expander("📥 ดูวิธี Download ไฟล์ยอดขายจาก TikTok"):
                                    st.write('''
                ...
                for j, sale_tab in enumerate(sale_tabs):
                    with sale_tab:
                        ...
                        if sale_tab_name == 'Shopee': 
                            with st.expander("📥 กดดูวิธี Download ไฟล์ยอดขายจาก Shopee"):
                                st.write('''
                                    1. Log in เข้า Shopee Seller Center\n
                                    2. เลือก "คำสั่งซื้อของฉัน"\n
                                    3. เลือก "ทั้งหมด"\n
                        ...
                        ################# upload TikTok #################
                            ...
                            with st.expander("📥 กดดูวิธี Download ไฟล์ยอดขายจาก TikTok"):
                                st.write('''
                                    1. Log in เข้า TikTok Seller Center
                                    2. เลือก "คำสั่งซื้อ" -> "จัดการคำสั่งซื้อ"\n
                                    3. เลือก "ทั้งหมด"\n
                ...
                for k, commission_tab in enumerate(commission_tabs):
                    with commission_tab:
                        ...
                        if commission_tab_name == 'Shopee': 
                            with st.expander("📥 กดดูวิธี Download ไฟล์ค่าธรรมเนียม Shopee"):
                                st.write('''
                            ...
                            with st.expander("📥 กดดูวิธี Download ไฟล์ค่าธรรมเนียม TikTok"):
                                st.write('''
                                    The chart above shows some numbers I picked for you.
                                    I rolled actual dice for these, so they're *guaranteed* to
                                    be random.
